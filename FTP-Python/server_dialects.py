...
class D2:
    ...
    def send_file(self, file_name):
        try:
            ...
            self.client_socket.sendall("{},{}".format(file_size,file_size).encode('utf-8'))
            time.sleep(1)
...
class D3:
    ...
    def send_file(self, file_name):
        try:
            ...
            ### after 29 June changes, we send "file present,filesize,filename" here.
            self.client_socket.sendall("{},{},{}".format('file present', int(file_size), file_name).encode('utf-8'))
            time.sleep(1)
